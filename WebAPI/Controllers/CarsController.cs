...
namespace WebAPI.Controllers
{
    ...
    public class CarsController : ControllerBase
    {
        ...
        public IActionResult GetCarDetailsByColorAndByBrand(int brandId, int colorId)
        {
            var result = _carService.GetCarDetailsByColorAndByBrand(brandId, colorId);
            if (result.Success)
            {
                return Ok(result);
            }
