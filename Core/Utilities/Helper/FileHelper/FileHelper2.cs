...
{
    public class FileHeplerManager2 : IFileHelper
    {
        ...
        {
            if (file.Length > 0)  //file.Length=>Dosya uzunluğunu bayt olarak alır. burada Dosya gönderilmiş mi gönderilmemiş mi diye test işlemi yapıldı.
            {
